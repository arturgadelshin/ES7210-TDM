...
es7210_tdm_ns = cg.esphome_ns.namespace("es7210_tdm")
ES7210TDM = es7210_tdm_ns.class_("ES7210TDM", cg.Component, i2c.I2CDevice)

es7210_bits_per_sample = es7210_tdm_ns.enum("ES7210BitsPerSample")
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(ES7210TDM),
